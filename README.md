...
| [`building-design`](skills/building-design/) | Produce design.md visual systems, static design-handoff prompts (Claude Design, Google Stitch, Figma Make), and HTML screen boards from PRDs, user stories, and UI specs. |

...
Working directory and production branch from [discovering-supabase-root.md](./discovering-supabase-root.md).
...
5. Set **Working directory** to the discovered Supabase root path.
...
- [discovering-supabase-root.md](./discovering-supabase-root.md)

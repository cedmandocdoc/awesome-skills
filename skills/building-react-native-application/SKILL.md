...
- UI, state, API, async loading/error/refresh/list UI ([managing-async-view.md](./references/managing-async-view.md)), routing/navigation stacks (screens + route params), or styling work that should follow this skill's conventions

...
| **Theming**               | [setting-up-theming.md](./references/setting-up-theming.md), [setting-up-tailwind-theme.md](./references/setting-up-tailwind-theme.md), [setting-up-navigation-theme.md](./references/setting-up-navigation-theme.md), [reusing-navigation-background.md](./references/reusing-navigation-background.md) | Tokens, Tailwind extend, nav chrome; stack/tab fill vs surface layers — see linked docs (especially **reusing-navigation-background**) |
...
| **Async / loading UI**    | [managing-async-view.md](./references/managing-async-view.md)                                                                                                                                                         | AsyncView, AsyncScrollView, AsyncFlatList; `isLoading` / `isReloading` / `isLoadingMore`, error, refresh, pagination |
| **Forms (TanStack Form)** | [managing-form-components.md](./references/managing-form-components.md), [TanStack Form — Basic concepts](https://tanstack.com/form/latest/docs/framework/react/guides/basic-concepts), [Form composition](https://tanstack.com/form/latest/docs/framework/react/guides/form-composition) | `src/ui/Form.tsx`, `createFormHook` + pre-bound fields; reuse `Field` / `Button`; validation and submit via official guides |

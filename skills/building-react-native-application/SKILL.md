...
| **Theming**               | [setting-up-theming.md](./references/setting-up-theming.md), [setting-up-tailwind-theme.md](./references/setting-up-tailwind-theme.md), [setting-up-navigation-theme.md](./references/setting-up-navigation-theme.md), [setting-up-registry-components.md](./references/setting-up-registry-components.md) | Tokens, Tailwind extend, nav theme, `PortalHost`     |
| **Component placement**   | [placing-component.md](./references/placing-component.md)                                                                                                                                                             | Deciding `src/ui/` vs `src/features/`                  |
| **Component creation**    | [creating-component.md](./references/creating-component.md), [setting-up-registry-components.md](./references/setting-up-registry-components.md)                                                                      | Primitives, compound parts; `PortalHost` for overlays |

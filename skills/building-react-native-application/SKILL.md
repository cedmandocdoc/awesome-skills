...
| Project bootstrap                   | [managing-project-structure](./references/managing-project-structure.md), [managing-environment](./references/managing-environment.md), [managing-linting](./references/managing-linting.md), [setting-up-registry-components](./references/setting-up-registry-components.md), [NativeWind — Installation](https://www.nativewind.dev/docs/getting-started/installation)                                                                                                                                                                                                                                                                                                         |

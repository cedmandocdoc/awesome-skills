...
| [Form composition](https://tanstack.com/form/latest/docs/framework/react/guides/form-composition) | Compose reusable form parts and advanced form structures. |
...
| [Native Stack Navigator](https://reactnavigation.org/docs/native-stack-navigator/) | Build stack flows, screen options, and transitions. |
| [Native Bottom Tabs Navigator](https://reactnavigation.org/docs/native-bottom-tab-navigator/) | Implement tab navigation and tab-level screen structure. |
...
| [react-native-keyboard-controller — Components overview](https://kirillzyusko.github.io/react-native-keyboard-controller/docs/guides/components-overview) | Handle keyboard avoidance, sticky views, and scroll synchronization. |
| [Expo SplashScreen](https://docs.expo.dev/versions/latest/sdk/splash-screen/) | Configure splash assets/plugin and control hide timing at app startup. |

...
**Authoring mode.** Creates or updates Markdown documentation in the project, including skills (`SKILL.md`), rules, and similar instructional content.
...
Before drafting new documentation, satisfy one of the following:
...
Updates to existing docs skip this step unless the user is effectively starting a new doc from scratch.
...
**Create:** User asks to document a new API endpoint. Propose outline if no template → draft concise reference with backticks on paths and commands.

...
| --- | --- | --- |
| UI (presentation-only) | `src/ui/` | Generic: `Button`, `TextInput`, `Dialog` |
| Feature (domain behavior) | `src/features/*/components/` | Prefixed: `CheckoutButton`, `SearchInput`, `DeleteUserDialog` |

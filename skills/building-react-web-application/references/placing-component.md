...
- Composition roots such as `src/ui/Form/` are allowed when a subsystem owns multiple related files (see [managing-form-components.md](./managing-form-components.md)).

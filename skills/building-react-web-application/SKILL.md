...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| **Project structure**       | [structuring-project.md](./references/structuring-project.md)                                                                                                                                                                                                             | Folders, providers, `components.json` + `src/ui`, imports               |
...
| **Theming & tokens**        | [setting-up-theming.md](./references/setting-up-theming.md), [setting-up-tailwind-theme.md](./references/setting-up-tailwind-theme.md)                                                                                                                                    | shadcn manual deps + global CSS; semantic token usage                   |
...
| **Adding UI from registry** | Run `npx shadcn@latest add <component>` or [scripts/add-registry-component.js](./scripts/add-registry-component.js)                                                                                                                                                       | Inspect or vendor registry output into `src/ui/` with `cx` + path fixes |

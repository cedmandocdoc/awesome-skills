...
| **Adding UI from registry** | [scripts/add-registry-component.js](./scripts/add-registry-component.js) (`npx shadcn@latest view` under the hood)                                                                                                                                                          | Vendor registry output into `src/ui/` with `cx` + path fixes            |
